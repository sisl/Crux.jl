...
𝒮 = DQN(π=Q(), S=S, N=5000000, buffer_size=100000, max_steps=1000, buffer_init=5000, log=(fns=[log_undiscounted_return(1)],), c_opt=(optimizer=Flux.Optimiser(ClipValue(1f0), ADAM(1f-3)),))
solve(𝒮, mdp)
